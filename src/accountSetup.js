...
class AccountSetup extends React.Component{
    ...
    addNewUser = () => {
        ...
        this.props.history.push('/homeViewing')
    }

    render(){ 
        if(this.props.signedUp){
            const user = data.getUserInfo("admin@mail.com")
            return(
            ...
            <form>
                <div class="form-group bg-#000000 text-white">
                    ...
                    <input type="text" style={{backgroundColor: "#262626", color: "white"}} class="form-control bg-#262626 col-sm-2" id="Username" value={user.name}/>
                </div>
                <div class="form-group bg-#262626 text-white">
                    <label for="Email">Email:</label>
                    <input type="text" style={{backgroundColor: "#262626", color: "white"}} class="form-control bg-#262626 col-sm-2" id="Email" value={user.email}/>
                </div>
                <div class="form-group bg-#262626 text-white">
            ...
            <div class="form-group bg-#262626 text-white">
                ...
                <input type="text" style={{backgroundColor: "#262626", color: "white"}} value={user.likedMovies} class="form-control bg-#262626 col-sm-4" id="Liked_Movies"/>
            </div>
            <div class="form-group bg-#262626 text-white">
                <label for="Disliked_Movies">Movies you dislike:</label>
                <input type="text" style={{backgroundColor: "#262626", color: "white"}} value={user.dislikedMovies} class="form-control bg-#262626 col-sm-4" id="Disliked_Movies"/>
            </div>
